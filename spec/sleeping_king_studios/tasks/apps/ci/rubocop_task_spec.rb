# spec/sleeping_king_studios/tasks/apps/ci/rubocop_task_spec.rb

require 'sleeping_king_studios/tasks/apps/ci/rubocop_task'

RSpec.describe SleepingKingStudios::Tasks::Apps::Ci::RuboCopTask do
  ...
  describe '#call' do
    shared_examples 'should call the step runner with only => "rubocop"' do
      describe 'should call the step runner with only => "rubocop"' do
        ...
        it do
          expect(SleepingKingStudios::Tasks::Apps::Ci::StepsTask).
            to receive(:new).
